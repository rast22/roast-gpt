...
Harshness comes from a precise observation, blunt wording and natural uncensored profanity. The instructions avoid fabricated incidents and personal facts. Genuine distress and requests to stop receive a short ordinary response. These are model instructions, not a claim that every generated reply is guaranteed to follow them.
